...
const proxyHandlerMiddle: Connect.NextHandleFunction = (req, res) => {
  console.log('proxyHandlerMiddle:', req.headers, req.url, req.originalUrl);
  ...
  if (req.method === 'OPTIONS') {
    ...
    try {
      ...
      res.statusCode = 200;
      // req.headers["cookie"] = "access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Ilx1MjAwZWVkd2FyZC5lbHJpYzk2QFx1MjAwYmFvbC5jb20iLCJ1c2VyX2lkIjoyMTAsInVzZXJuYW1lIjoidXNlcl8yMDI1MDYwNjA0MjkxMSIsImF2YXRhcl9wYXRoIjpudWxsLCJleHAiOjE3NjQ4MTA1MzMsImdlbWluaV9rZXkiOiJBSXphU3lBTEJTM2k2MndHTDJmcGJ1TVIySFh5ejhTcnZWOTZhRm8ifQ.VyfwU4di8F3-x_HHECf2-LMnV6vcRsP-Es-CWf_FCAY"
